 ...
 */
export declare function getEnvString(env: Record<string, unknown>, key: string): string | undefined;
/**
 ...
 */
export declare function filterEnvVars(envVars: Record<string, string | undefined | null>): Record<string, string>;
/**
 ...
 * ```
 */
export declare function partitionEnvVars(envVars: Record<string, string | undefined | null>): {
