 ...
 */
export declare function isWSPtyInput(msg: unknown): msg is WSPtyInput;
/**
 * Type guard for WSPtyResize
 */
export declare function isWSPtyResize(msg: unknown): msg is WSPtyResize;
/**
 ...
 */
export declare function isWSRequest(msg: unknown): msg is WSRequest;
/**
 * Type guard for WSResponse
 *
 * Note: Only validates the discriminator field (type === 'response').
 */
export declare function isWSResponse(msg: unknown): msg is WSResponse;
/**
 * Type guard for WSStreamChunk
 *
 * Note: Only validates the discriminator field (type === 'stream').
 */
export declare function isWSStreamChunk(msg: unknown): msg is WSStreamChunk;
/**
 * Type guard for WSError
 *
 * Note: Only validates the discriminator field (type === 'error').
 */
export declare function isWSError(msg: unknown): msg is WSError;
/**
